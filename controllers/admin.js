...
exports.postAddproduct = (req, res, next) => {
    ...
    const product = new Products(title , imageUrl ,price ,description);//create a new const based on Product class and req.body is often used in web applications to access data that has been sent to the server as part of an HTTP request. 
